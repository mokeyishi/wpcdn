...
function gm_enqueue_sal_scripts() {
    if( is_front_page() ) {
        wp_enqueue_style( 'sal', 'https://cdn.jsdelivr.net/gh/mokeyishi/wpcdn/wp-content/themes/generatepress/sal/sal.css' );
        wp_enqueue_script( 'sal', 'https://cdn.jsdelivr.net/gh/mokeyishi/wpcdn/wp-content/themes/generatepress/sal/sal.js', array(), false, true );
        wp_enqueue_script( 'sal-init', 'https://cdn.jsdelivr.net/gh/mokeyishi/wpcdn/wp-content/themes/generatepress/sal/sal-init.js', null, null, true );
    }
}
