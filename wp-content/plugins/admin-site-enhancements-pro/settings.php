			...
			<form action="options.php" method="post">
				<div class="asenha-vertical-tabs">
					<div class="asenha-tab-buttons">
					    ...
					    <input id="tab-login-logout" type="radio" name="tabs"><label for="tab-login-logout"><?php echo wp_kses( $icon_login_logout, get_kses_with_svg_ruleset() ); ?><?php echo esc_html__( 'Log In/Out | Register', 'admin-site-enhancements' ); ?></label>
